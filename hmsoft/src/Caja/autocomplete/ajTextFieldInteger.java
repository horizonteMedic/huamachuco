 ...
 * @author usuario
 */
public class ajTextFieldInteger {
    /**
    ...
    public static class autocompleterText extends KeyAdapter
    {
        ...
        private class keyforString extends KeyAdapter
        {
            ...
            public void keyReleased(KeyEvent e)
            {
                ...
                ajTextFieldInteger.addTextAndSelectToTextFieldToRest(textField, ajVarios.getTextoApartirVector(textField.getText(), veDatos));
            }
        }
        ...
        public void keyReleased(KeyEvent e)
        {
          ...
          if (e.getKeyCode() >= 8 && e.getKeyCode() <= 46 || e.getKeyCode() >= 106 && e.getKeyCode() <= 221 ) {
                  return;
             }
            if(textField.getText().isEmpty()) {
                return;
            ...
            datoCompletar = ajSQL.getCampoUnicoStrin("select "+campo+" from "+tabla+" where CAST("+campo+" as text) like upper('"+textField.getText()+"%') limit 1");
