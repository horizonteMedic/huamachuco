...
//declarations for table
    ...
    public AutoTextComplete() {
        ...
        setButtons();
//((JPanel)this.getContentPane()).setBorder(BorderFactory.createLineBorder(Color.DARK_GRAY, 0));
        lst.setToolTipText("Presionar F5, F6 para Navegar, F7 para Seleccionar");
    }
    ...
    private void setButtons() {
        JButton b[] = {new JButton("subir"), new JButton("bajar"), new JButton("agregar")};
        char c[] = {'S', 'B', 'A'};
        String txt[] = {"Arriba (F5)", "Abajo (F6)", "Seleccionar (F7)"};
