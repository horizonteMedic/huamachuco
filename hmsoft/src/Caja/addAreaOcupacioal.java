 ...
 */
public class addAreaOcupacioal extends javax.swing.JDialog {
    public static RegistrarCliente registrar;
       clsFunciones  oFunc = new clsFunciones();
      clsConnection oConn = new clsConnection();
    public addAreaOcupacioal(RegistrarCliente parent, boolean modal) {
        //super(parent, modal);
        addAreaOcupacioal.registrar = parent;
        this.setModal(modal);
        initComponents();
...
kb.addKeyEventPostProcessor(new KeyEventPostProcessor(){
    ...
    private void initComponents() {
        ...
        setTitle("Agrege su Área Ocupacional y ESC para Cerrar");
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        jPanel1.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jLabel1.setText("Agregar Area Ocupacional:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addAreaOcupacioal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                addAreaOcupacioal dialog = new addAreaOcupacioal(registrar, true);
    ...
    if (seleccion != -1)
{
   if((seleccion + 1)==1)
   {
      ...
      registrar.cboAreaOcupacional(txtAddOcupacion.getText());
