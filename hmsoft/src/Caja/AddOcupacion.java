 ...
 */
public class AddOcupacion extends javax.swing.JDialog {
    public static RegistrarCliente registrar;
       clsFunciones  oFunc = new clsFunciones();
      clsConnection oConn = new clsConnection();
    public AddOcupacion(RegistrarCliente parent, boolean modal) {
        //super(parent, modal);
        AddOcupacion.registrar = parent;
        this.setModal(modal);
        initComponents();
...
kb.addKeyEventPostProcessor(new KeyEventPostProcessor(){
    ...
    private void initComponents() {
        ...
        setTitle("Agrege su Ocupación y ESC para Cerrar");
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        jPanel1.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jLabel1.setText("Nombre Ocupación / Profesión:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddOcupacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                AddOcupacion dialog = new AddOcupacion(registrar, true);
