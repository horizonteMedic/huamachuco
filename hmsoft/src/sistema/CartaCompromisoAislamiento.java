 ...
 * @author Richard
 */
public class CartaCompromisoAislamiento extends javax.swing.JInternalFrame {
 ...
 String codvalor="";
    ...
    public CartaCompromisoAislamiento() {
        initComponents();
        activar(false);
    }
    ...
    private void initComponents() {
        ...
        FechaCarta = new com.toedter.calendar.JDateChooser();
        ...
        jLabel2.setText("Con fecha");

        jLabel1.setText(", yo");

        jLabel5.setText("identificado con DNI:");

        jLabel7.setText(", trabajador de la Unidad Minera ");

        jLabel8.setText(", de la empresa ");

        jLabel9.setText("<html>en cumplimiento al protocolo para la implementación de medidas de prevención y respuesta frente al COVID – 19 en el <br>  marco de las acciones de traslado de personal de las unidades mineras y Unidades de Producción (RM 111-2020-MINEM/DM) <br> me comprometo voluntariamente a cumplir de manera estricta la CUARENTENA relacionada al COVID – 19 por diez (10) días <br> calendario en mi domicilio, guardando el aislamiento social y me someto a las pruebas y evaluaciones necesarias para descartar<br>  el contagio del COVID – 19. </html>");
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addComponent(FechaCarta, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(FechaCarta, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
...
public boolean OrdenExiste()
    {
        ...
        sQuery  = "Select n_orden from carta_compromiso_aislamiento Where n_orden ="+txtNorden.getText().toString();
...
private boolean Grabar() throws SQLException{
       ...
       String strSqlStmt ="INSERT INTO carta_compromiso_aislamiento(n_orden,fecha_carta, fecha_hoy)";       
            strSqlStmt+= "values ('"+ txtNorden.getText().toString()+"','"+FechaCarta.getDate()+
                    "','"+FechaHoy.getDate()+"' )";
...
//                   oConn.setResult.next();
	...
	valorSede(seded);
        ...
        String Sql="SELECT d.cod_pa, d.nombres_pa||' '||d.apellidos_pa as nombre, d.fecha_nacimiento_pa ,"
                + "n.razon_empresa,n.razon_contrata ,n.n_orden,o.fecha_carta,o.fecha_hoy "
                + "FROM datos_paciente AS d "
                + "INNER JOIN n_orden_ocupacional AS n ON (d.cod_pa = n.cod_pa) "
                + "INNER JOIN carta_compromiso_aislamiento AS o ON (o.n_orden = n.n_orden) "
               + "WHERE n.n_orden ="+txtNorden.getText().toString() +" AND n.cod_Sede="+codvalor;
         oConn.FnBoolQueryExecute(Sql);
                try {
                    if (oConn.setResult.next()) {
                        ...
                        txtDNI.setText(oConn.setResult.getString("cod_pa"));
                        Fecha();
                        FechaCarta.setDate(oConn.setResult.getDate("fecha_carta"));
                        FechaCarta.setEnabled(true);
//                        FechaHoy.setDate(oConn.setResult.getDate("fecha_hoy"));
    ...
    private void print(Integer cod){
                ...
                try 
                {
                        ...
                        String direccionReporte = System.getProperty("user.dir") + File.separator + "reportes" + File.separator + "CartaCompromisoAislamiento.jasper";
       ...
       private void print12(Integer cod){
                ...
                try 
                {
                        ...
                        String direccionReporte = System.getProperty("user.dir") + File.separator + "reportes" + File.separator + "CartaCompromisoAislamiento12.jasper";
                        JasperReport myReport = (JasperReport) JRLoader.loadObjectFromFile(direccionReporte);
                        JasperPrint myPrint = JasperFillManager.fillReport(myReport, parameters, clsConnection.oConnection);
                        JasperViewer viewer = new JasperViewer(myPrint, false);
                        viewer.setTitle("CARTA DE COMPROMISO DE AISLAMIENTO VOLUNTARIO");
    ...
    private void Actualizar(){
        ...
        String strSqlStmt;
        strSqlStmt="UPDATE carta_compromiso_aislamiento\n" +
                    "   SET  fecha_carta='"+FechaHoy.getDate()+"',"
                + " fecha_hoy='"+FechaCarta.getDate()+"'" +
