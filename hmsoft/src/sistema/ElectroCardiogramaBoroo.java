 ...
 * @author admin
 */
public final class ElectroCardiogramaBoroo extends javax.swing.JInternalFrame {
   ...
   clsOperacionesUsuarios oPe = new clsOperacionesUsuarios();
    ...
    public void cerrarVentana(){
        ...
        System.out.println("cerro esta ventana");
              try {
                  ...
                  Logger.getLogger(ElectroCardiogramaBoroo.class.getName()).log(Level.SEVERE, null, ex);
              }
    ...
    public ElectroCardiogramaBoroo() {
        initComponents();
