 ...
 * @author Richard
 */
public class ConstanciaAltaEpidemiologica extends javax.swing.JInternalFrame {
 ...
 String codvalor="";
    ...
    public ConstanciaAltaEpidemiologica() {
        initComponents();
        activar(false);
    }
    ...
    private void initComponents() {
        ...
        atxtResultado = new javax.swing.JTextArea();
        ...
        jLabel2.setText("Conste por la presente que el Sr.(a):");

        jLabel5.setText("identificado con DNI:");

        jLabel7.setText("Paciente asintomático que presentó: ");

        FechaHoy.setDateFormatString("'TRUJILLO - ' EEEEE dd MMMMM yyyy");

        jLabel8.setText("colaborador de la empresa ");

        jLabel3.setText("<html>Por tal motivo se indica ALTA EPIDEMIOLOGICA y se le recomienda evaluación en tópico de la empresa donde labora. </html>");

        jLabel4.setText("Edad :");

        jLabel9.setText("ha sido evaluado por mi persona:");

        atxtResultado.setColumns(20);
        atxtResultado.setRows(5);
        jScrollPane1.setViewportView(atxtResultado);
...
private void CargarSedes1(){
    ...
    public boolean OrdenExiste()
    {
        ...
        sQuery  = "Select n_orden from constancia_alta_epidemiologica Where n_orden ="+txtNorden.getText().toString();
...
private boolean Grabar() throws SQLException{
       ...
       String strSqlStmt ="INSERT INTO constancia_alta_epidemiologica(n_orden,fecha_examen,txtresultados)";       
            strSqlStmt+= "values ('"+ txtNorden.getText().toString()+"',"
                    + "'"+ FechaHoy.getDate()+"',"
                    + "'"+atxtResultado.getText()+"' )";
...
//                   oConn.setResult.next();
	...
	valorSede(seded);
        ...
        String Sql="SELECT d.cod_pa, d.nombres_pa||' '||d.apellidos_pa as nombre,d.fecha_nacimiento_pa, "
                + "n.razon_empresa,c.fecha_examen,c.txtresultados "
                + "FROM datos_paciente AS d "
                + "INNER JOIN n_orden_ocupacional AS n ON (d.cod_pa = n.cod_pa) "
                + "INNER JOIN constancia_alta_epidemiologica AS c ON (c.n_orden = n.n_orden) "
               + "WHERE n.n_orden ="+txtNorden.getText().toString() +" AND n.cod_Sede="+codvalor;
         oConn.FnBoolQueryExecute(Sql);
                try {
                    if (oConn.setResult.next()) {
                      ...
                      //  txtSexo.setText(oConn.setResult.getString("sexo_pa").equals("M")?"MASCULINO" : "FEMENINO");   
                        txtEmpresa.setText(oConn.setResult.getString("razon_empresa"));
                        atxtResultado.setText(oConn.setResult.getString("txtresultados"));
                        Fecha();
//                        FechaHoy.setDate(oConn.setResult.getDate("fecha_hoy"));
    ...
    private void print(Integer cod){
                ...
                try 
                {
                        String direccionReporte = System.getProperty("user.dir") + File.separator + "reportes" + File.separator + "Constancia_Alta_Epidemiologica.jasper";
        ...
        private void print12(Integer cod){
                ...
                try 
                {
                        String direccionReporte = System.getProperty("user.dir") + File.separator + "reportes" + File.separator + "Constancia_Alta_Epidemiologica12.jasper";
                        JasperReport myReport = (JasperReport) JRLoader.loadObjectFromFile(direccionReporte);
                        JasperPrint myPrint = JasperFillManager.fillReport(myReport, parameters, clsConnection.oConnection);
                        JasperViewer viewer = new JasperViewer(myPrint, false);
                        viewer.setTitle("CONSTANCIA MÉDICA COVID 19");
    ...
    private void Actualizar(){
        ...
        String strSqlStmt;
        strSqlStmt="UPDATE constancia_alta_epidemiologica\n" +
                    "   SET  fecha_examen='"+FechaHoy.getDate()+"',"
                + "          txtresultados='"+atxtResultado.getText()+"'" +
...
public void cerrarVentana(){
    ...
    private javax.swing.JTextArea atxtResultado;
