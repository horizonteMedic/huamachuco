 ...
 * @author Richard
 */
public final class LaboratorioClinicoAsistencial1 extends javax.swing.JInternalFrame {
clsConnection oConn = new clsConnection();
   ...
   int valor=1;
    public LaboratorioClinicoAsistencial1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(jtLaboratorio, javax.swing.GroupLayout.DEFAULT_SIZE, 649, Short.MAX_VALUE)
                .addContainerGap())
        );
      ...
      String sQuery;        
        ...
        if (oConn.FnBoolQueryExecute(sQuery))
        {
            ...
            catch (SQLException ex) 
            {
                ...
                Logger.getLogger(LaboratorioClinicoAsistencial1.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
...
//                txtNorden.setText(null);
    ...
    public boolean Recibo() {
        boolean bResultado = false;
        String sQuery = "Select * from lab_clinico Where num_ticket=" + txtNorden.getText().toString();
        oConn.FnBoolQueryExecute(sQuery);
        try {
            if (oConn.setResult.next()) {
                bResultado = true;
