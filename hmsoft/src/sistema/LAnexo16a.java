 ...
 * @author admin
 */
public class LAnexo16a extends javax.swing.JInternalFrame {
   ...
   @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("ANEXO 16 A", jPanel3);
...
"                   FROM datos_paciente AS d \n" +
"                   INNER JOIN n_orden_ocupacional AS n ON (d.cod_pa = n.cod_pa)    \n" +
"                   INNER JOIN lanexo16a AS t ON (t.n_orden = n.n_orden)  \n" +
...
//        }
    ...
    public boolean OrdenExiste(){
        boolean bResultado=false;
         if (!txtNorden.getText().isEmpty()) {
             String sQuery;
             sQuery = "Select n_orden from lanexo16a where n_orden=" + txtNorden.getText();
    ...
    private void print(Integer cod) {
     ...
     public void Actualizar() {
        ...
        if (oConn.FnBoolQueryExecuteUpdate(strSqlStmt)){
            ...
            try {
                ...
                Logger.getLogger(LAnexo16a.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
     ...
     private boolean Grabar() throws SQLException {
        ...
        String strSqlStmt = "INSERT INTO lanexo16a(\n" +
