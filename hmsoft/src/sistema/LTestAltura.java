 ...
 * @author admin
 */
public class LTestAltura extends javax.swing.JInternalFrame {
   ...
   @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(jPanel4Layout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)
                            .addComponent(txtGlucosaBio, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanel4Layout.createSequentialGroup()
                            .addGap(29, 29, 29)
                            .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        jTabbedPane1.addTab("TEST ALTURA", jPanel3);
...
"                   FROM datos_paciente AS d \n" +
"                   INNER JOIN n_orden_ocupacional AS n ON (d.cod_pa = n.cod_pa)    \n" +
"                   INNER JOIN ltest_altura AS t ON (t.n_orden = n.n_orden)  \n" +
"                   WHERE t.n_orden ="+txtNorden.getText()+";";
            ...
            try {
                if (oConn.setResult.next()) {
                    ...
                    txtGlucosaBio.setText(oConn.setResult.getString("txtglucosa"));
...
//        }
    ...
    public boolean OrdenExiste(){
        boolean bResultado=false;
         if (!txtNorden.getText().isEmpty()) {
             String sQuery;
             sQuery = "Select n_orden from ltest_altura where n_orden=" + txtNorden.getText();
    ...
    private void print(Integer cod) {
     ...
     public void Actualizar() {
        ...
        String strSqlStmt;
        strSqlStmt = "UPDATE  ltest_altura\n "
                ...
                + "       txtglucosa='" + txtGlucosaBio.getText() + "'"
        ...
        if (oConn.FnBoolQueryExecuteUpdate(strSqlStmt)){
            ...
            try {
                ...
                Logger.getLogger(LTestAltura.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
     ...
     private boolean Grabar() throws SQLException {
        ...
        String strSqlStmt = "INSERT INTO ltest_altura(\n" +
