 ...
 * @author admin
 */
public final class ElectroCardiogramaPoderosa extends javax.swing.JInternalFrame {
   ...
   clsOperacionesUsuarios oPe = new clsOperacionesUsuarios();
    ...
    public ElectroCardiogramaPoderosa() {
        initComponents();
    ...
    private void initComponents() {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(atxtObservacionesAltura1, javax.swing.GroupLayout.PREFERRED_SIZE, 475, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel27)
                    .addComponent(atxtObservacionesAltura1, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(5, 5, 5)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jLabel16)
...
dispose();
    ...
    private void chkFisiologicaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkFisiologicaActionPerformed
       ...
       txtObservaciones.append("BRADICARDIA SINUSAL FISIOLOGICA. ");
    ...
    private void chkAsintomaticaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkAsintomaticaActionPerformed
       ...
       txtObservaciones.append("BRADICARDIA SINUSAL ASINTOMATICA. ");
        txtRecomendaciones.append("- EVALUACION ANUAL." + '\n');}
    ...
    private void chkRamaDerechaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkRamaDerechaActionPerformed
       ...
       txtObservaciones.append("BLOQUEO INCOMPLETO DE RAMA DERECHA. ");}
    ...
    private void chkCardiacoIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkCardiacoIActionPerformed
       ...
       txtObservaciones.append("DESVIACION IZQUIERDA DEL EJE CARDIACO. ");}
    ...
    private void chkCardiacoDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkCardiacoDActionPerformed
       ...
       txtObservaciones.append("DESVIACION DERECHA DEL EJE CARDIACO. ");}
    ...
    private void chkNormalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkNormalActionPerformed
        ...
        txtObservaciones.setText("NORMAL.");
        txtRecomendaciones.append("- EVALUACION ANUAL." + '\n');}
...
//    if(txtOndaP.getText().isEmpty()){bResultado = false;}
...
public void Actualizar(){
    String sCodigo=txtNorden.getText();
        ...
        strSqlStmt="UPDATE informe_electrocardiograma_poderosa\n" +
                ...
                + " f_c='"+txtFC.getText()+"',"
                + "eje='"+txtEje.getText()+"',"
                + "onda_p='"+txtOndaP.getText()+"',"    
                + "p_r='"+txtPR.getText()+"',"
                + "q_r_s='"+txtQRS.getText()+"', "
                + "s_t='"+txtSt.getText()+"', "
                + "onda_t='"+txtOndaT.getText()+"', "
                + "q_t='"+txtQT.getText()+"', "
                + "observacion='"+txtObservaciones.getText()+"', "
                + "conclusion='"+txtConclusiones.getText()+"',"
