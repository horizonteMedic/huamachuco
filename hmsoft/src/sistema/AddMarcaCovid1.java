 ...
 * @author Deymer
 */
public class AddMarcaCovid1 extends javax.swing.JDialog {
    public static LaboratorioClinicoCovid registrar;
       clsFunciones  oFunc = new clsFunciones();
      clsConnection oConn = new clsConnection();
    public AddMarcaCovid1(LaboratorioClinicoCovid parent, boolean modal) {
        //super(parent, modal);
        AddMarcaCovid1.registrar = parent;
        this.setModal(modal);
        initComponents();
...
kb.addKeyEventPostProcessor(new KeyEventPostProcessor(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddMarcaCovid1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                AddMarcaCovid1 dialog = new AddMarcaCovid1(registrar, true);
