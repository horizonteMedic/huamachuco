 ...
 * @author admin
 */
public final class Audiometria2023 extends javax.swing.JInternalFrame {
   ...
   DefaultTableModel model;
    ...
    private void initComponents() {
        ...
        txtDiagOD = new javax.swing.JTextField();
        jButton1 = new javax.swing.JButton();
        txtDiagOI = new javax.swing.JTextField();
        atxtObservacionesAltura1 = new javax.swing.JScrollPane();
        txtDiagComentarios = new javax.swing.JTextArea();
        ...
        jLabel49.setText("Años de Exposición (Aprox.)");

        jLabel50.setText("Meses");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(38, 38, 38)
                        .addComponent(txtAños, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(txtMeses, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE))))
        );
        ...
        jLabel47.setText("Oído Derecho: ");

        jLabel48.setText("Oído Izquierdo: ");
        ...
        txtDiagComentarios.setColumns(20);
        txtDiagComentarios.setRows(2);
        txtDiagComentarios.setBorder(javax.swing.BorderFactory.createTitledBorder("COMENTARIOS"));
        atxtObservacionesAltura1.setViewportView(txtDiagComentarios);
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtDiagOD)
                    .addComponent(txtDiagOI))
                .addGap(10, 10, 10))
            .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createSequentialGroup()
                    .addComponent(atxtObservacionesAltura1, javax.swing.GroupLayout.DEFAULT_SIZE, 394, Short.MAX_VALUE)
                    .addContainerGap()))
        );
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel47)
                    .addComponent(txtDiagOD, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel48)
                    .addComponent(txtDiagOI, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(106, 106, 106))
            .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel7Layout.createSequentialGroup()
                    .addGap(79, 79, 79)
                    .addComponent(atxtObservacionesAltura1, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel8Layout.setVerticalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(atxtObservacionesAltura, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE)
...
"       a.o_i1_2000, a.o_i1_3000, a.o_i1_4000, a.o_i1_6000, a.o_i1_8000,a.txtdiag_od,a.txtdiag_oi,txtcomentarios,  \n" +
"       a.chkrpasimple, a.chkrpadoble, a.chkcasemestral, a.chkcaanual, a.txtotrasrecomendaciones,txtanios,txtmeses "
                    + "FROM datos_paciente as d "
                    +"INNER JOIN n_orden_ocupacional as n ON (d.cod_pa  = n.cod_pa )"
                    +"INNER JOIN audiometria_2023 as a ON (n.n_orden = a.n_orden)"
             ...
             oConn.FnBoolQueryExecute(Sql);
                try {
                    if (oConn.setResult.next()) {
                        ...
                        txtDiagOD.setText(oConn.setResult.getString("txtdiag_od"));
                        txtDiagOI.setText(oConn.setResult.getString("txtdiag_oi"));
                        txtDiagComentarios.setText(oConn.setResult.getString("txtcomentarios"));
                       ...
                       txtAños.setText(oConn.setResult.getString("txtanios"));
                       txtMeses.setText(oConn.setResult.getString("txtmeses"));
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if(validar()){
            strSqlStmt="UPDATE audiometria_2023 ";
            Query="SET ";
            ...
            Query += ",txtdiag_od='"+txtDiagOD.getText()+ "'";
            Query += ",txtDiag_oi='"+txtDiagOI.getText()+ "'";
            Query += ",txtcomentarios='"+txtDiagComentarios.getText()+ "'";
            ...
            Query += ",txtanios='"+txtAños.getText()+ "'";
...
if(!txtImp.getText().isEmpty()){
 ...
 private void print(Integer cod){
    ...
    private javax.swing.JTextArea txtDiagComentarios;
    private javax.swing.JTextField txtDiagOD;
    private javax.swing.JTextField txtDiagOI;
...
public void Limpiar(){
    ...
    txtDiagOI.setText(null);
    bgRPA.clearSelection();
    bgRCA.clearSelection();
    txtDiagOD.setText(null);
    txtDiagOI.setText(null);

    txtDiagComentarios.setText(null);
    txtOtrasRecomendaciones.setText(null);
...
public void Agregar(){
    if(!OrdenExiste()){
        if(validar()){
            String strSqlStmt;
            String Query ;
            strSqlStmt="INSERT INTO audiometria_2023(";
            Query="Values('";
            ...
            strSqlStmt += ",txtdiag_od";Query += ",'"+txtDiagOD.getText()+ "'";
            strSqlStmt += ",txtdiag_oi";Query += ",'"+txtDiagOI.getText()+ "'";
            strSqlStmt += ",txtcomentarios";Query += ",'"+txtDiagComentarios.getText()+ "'";
            ...
            strSqlStmt += ",txtanios";Query += ",'"+txtAños.getText()+ "'";
            strSqlStmt += ",txtmeses";Query += ",'"+txtMeses.getText()+ "'";
...
private boolean validar(){
    ...
    public boolean OrdenExiste()
    {
        ...
        sQuery  = "Select n_orden from audiometria_2023 Where n_orden="+txtNumero.getText().toString();
...
//            JasperViewer.viewReport(myPrint, false);
    ...
    if (!txtOD500.getText().equals("N/A")) {
        ...
        float prom = (od500+od1000+od2000+od4000)/4;
        float prom1 = (oi500+oi1000+oi2000+oi4000)/4;

        if (prom <= 25) {
            txtDiagOD.setText("- NORMAL \n");
        } else if( prom > 25 && prom <= 40){
            txtDiagOD.setText("- HIPOACUSIA LEVE \n");     
        } else if (prom > 40 && prom <= 55) {
            txtDiagOD.setText("- HIPOACUSIA MODERADA \n");    
        } else if (prom > 55 && prom <= 70) {
            txtDiagOD.setText("- HIPOACUSIA MODERADA SEVERA \n");  
        } else if (prom > 70 && prom <= 90) {
            txtDiagOD.setText("- HIPOACUSIA SEVERA \n");  
        } else if (prom >= 90) {
            txtDiagOD.setText("- HIPOACUSIA PROFUNDA \n");     
        }else{
            txtDiagOD.setText("- REVISAR DIAGNOSTICO \n");
        }
        if (prom1 <= 25) {
            txtDiagOI.setText("- NORMAL \n");
        } else if( prom1 > 25 && prom1 <= 40){
            txtDiagOI.setText("- HIPOACUSIA LEVE \n");     
        } else if (prom1 > 40 && prom1 <= 55) {
            txtDiagOI.setText("- HIPOACUSIA MODERADA \n");    
        } else if (prom1 > 55 && prom1 <= 70) {
            txtDiagOI.setText("- HIPOACUSIA MODERADA SEVERA \n");  
        } else if (prom1 > 70 && prom1 <= 90) {
            txtDiagOI.setText("- HIPOACUSIA SEVERA \n");  
        } else if (prom1 >= 90) {
            txtDiagOI.setText("- HIPOACUSIA PROFUNDA \n");     
        }else{
            txtDiagOD.setText("- REVISAR DIAGNOSTICO \n");
        }
    }
